...
}, 1), ${($_ = isset($this->services['security.user.provider.concrete.our_users']) ? $this->services['security.user.provider.concrete.our_users'] : $this->load('getSecurity_User_Provider_Concrete_OurUsersService.php')) && false ?: '_'}, 'main', new \Symfony\Component\Security\Core\User\UserChecker());
