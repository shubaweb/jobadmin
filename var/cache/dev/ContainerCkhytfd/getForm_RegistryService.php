...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\CompanyEdit' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CompanyEdit']) ? $this->services['AppBundle\Form\CompanyEdit'] : $this->services['AppBundle\Form\CompanyEdit'] = new \AppBundle\Form\CompanyEdit()) && false ?: '_'};
...
}, 'AppBundle\\Form\\SearchForm' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\SearchForm']) ? $this->services['AppBundle\Form\SearchForm'] : $this->services['AppBundle\Form\SearchForm'] = new \AppBundle\Form\SearchForm()) && false ?: '_'};
