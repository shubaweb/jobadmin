...
return $this->services['nelmio_alice.generator.resolver.value.chainable.php_value_resolver'] = new \Nelmio\Alice\Generator\Resolver\Value\Chainable\PhpFunctionCallValueResolver($this->parameters['nelmio_alice.functions_blacklist'], ${($_ = isset($this->services['nelmio_alice.generator.resolver.value.chainable.faker_value_resolver']) ? $this->services['nelmio_alice.generator.resolver.value.chainable.faker_value_resolver'] : $this->load('getNelmioAlice_Generator_Resolver_Value_Chainable_FakerValueResolverService.php')) && false ?: '_'});
